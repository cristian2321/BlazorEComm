...
namespace BlazorEComm.Server.Migrations
{
    ...
    [Migration("20231021170205_ConfigurationsType")]
    partial class ConfigurationsType
    {
            ...
            modelBuilder.Entity("BlazorEComm.Shared.Models.Configuration", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("cfd0de8c-1b4e-41b8-8df8-a21a0006577a"),
                            Activ = true,
                            Deleted = false,
                            Key = "ProductsByPage",
                            Language = "en",
                        ...
                        new
                        {
                            Id = new Guid("51c52403-856c-4f31-a448-d398951d1a4f"),
                            Activ = true,
                            Deleted = false,
                            Key = "DefaultLanguage",
                            Language = "",
                        ...
                        new
                        {
                            Id = new Guid("9a3b309e-51bd-4aba-a03f-8a502a7b6c0f"),
                            Activ = true,
                            Deleted = false,
                            Key = "CompanyName",
                            Language = "en",
                        ...
                        new
                        {
                            Id = new Guid("b5d84509-8597-4ea8-9adb-fee8659a065f"),
                            Activ = true,
                            Deleted = false,
                        ...
                        new
                        {
                            Id = new Guid("d0256da9-2ed3-413e-b25f-4b798f437448"),
                            Activ = true,
                            Deleted = false,
                            Key = "NoProductsFound",
                            Language = "en",
                        ...
                        new
                        {
                            Id = new Guid("da90eac8-e29b-4092-869c-fa5f37174b0e"),
                            Activ = true,
                            Deleted = false,
