...
namespace BlazorEComm.Server.Migrations
{
    ...
    [Migration("20231015201639_LanguageConfiguration2")]
    partial class LanguageConfiguration2
    {
            ...
            modelBuilder.Entity("BlazorEComm.Shared.Models.Configuration", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("2b5e41de-698f-49c9-a96e-2f66b2f6b9b6"),
                            Activ = true,
                            Key = "ProductsByPage",
                            Language = "en",
                            Value = "5"
                        ...
                        new
                        {
                            Id = new Guid("3cb117ff-6141-4158-b837-a89ce250ede3"),
                            Activ = true,
                            Key = "DefaultLanguage",
                            Language = "",
                            Value = "en"
